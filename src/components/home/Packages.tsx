      ...
      <div className={'mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'}>
        ...
        <div className={'mb-16 text-center'}>
          <h2 className={'mb-4 text-4xl sm:text-5xl dark:text-white'}>
            {t('Izaberi paket koji ti odgovara')}
          </h2>
        </div>
            ...
            <Link
              ...
              {pkg.priceNote ? (
                <div className={'absolute -top-3 left-1/2 -translate-x-1/2'}>
                  <span
                    className={
                      'inline-block rounded-full bg-linear-to-r from-yellow-400 to-orange-400 px-4 py-1 text-xs font-semibold text-black shadow'
                    }>
                    {'⭐ '}
                    {t(pkg.priceNote)}
                  </span>
