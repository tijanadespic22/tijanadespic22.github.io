            ...
            <div
              ...
              <div className={'w-full flex-1'}>
                <Link
                  ...
                  className={
                    'group relative block aspect-4/3 cursor-pointer overflow-hidden rounded-2xl bg-gray-200 dark:bg-gray-700'
                  }>
                  <img
                  ...
                  <div
                    className={
                      'absolute inset-0 flex items-end bg-linear-to-t from-black/60 to-transparent p-6 opacity-0 transition-opacity duration-300 group-hover:opacity-100'
                    }>
              ...
              <div className={'flex-1 space-y-4'}>
                <div
                  className={
                    'inline-block rounded-full border border-gray-200 bg-white px-3 py-1 text-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300'
                  }>
                  {t(project.category)}
                </div>
                ...
                <p
                  className={
                    'leading-relaxed wrap-break-word whitespace-normal text-gray-600 dark:text-gray-400'
                  }>
                ...
                <div className={'flex flex-wrap gap-2 pt-2'}>
                  {project.technologies.map(tech => (
                    <span
                      key={tech}
                      className={
                        'rounded-full bg-gray-100 px-3 py-1 text-sm text-gray-700 dark:bg-gray-700 dark:text-gray-300'
                      }>
                      {t(tech)}
                    </span>
                  ))}
