    ...
    <section className={'mx-auto max-w-7xl px-4 pt-32 pb-20 sm:px-6 lg:px-8'}>
      <div className={'grid items-center gap-16 lg:grid-cols-2'}>
        <div className={'relative order-2 lg:order-1'}>
          <div
            className={
              'relative mx-auto aspect-4/5 max-w-sm overflow-hidden rounded-3xl shadow-2xl lg:mx-0'
            }>
            <img
              src={'/cv.jpg'}
              alt={'Tijana Despić'}
        ...
        <div className={'order-1 space-y-6 lg:order-2'}>
          <div
            className={
              'inline-block rounded-full border border-blue-200 bg-blue-50 px-4 py-2 dark:border-blue-800 dark:bg-blue-950/40'
            }>
          ...
          <div className={'flex flex-wrap gap-4 pt-2'}>
            <Link
              href={'/about#contact'}
              className={
                'group inline-flex items-center gap-2 rounded-full bg-linear-to-r from-blue-600 to-purple-600 px-7 py-3.5 font-medium text-white transition hover:opacity-90'
              }>
              {t('Kontaktiraj me')}
              <ArrowIcon
                width={18}
