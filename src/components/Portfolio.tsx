        ...
        <div className="flex gap-6 overflow-x-scroll pb-2 [scrollbar-width:auto] [&::-webkit-scrollbar]:h-2 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-200 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-400 lg:block lg:space-y-12 lg:overflow-visible lg:pb-0 lg:[scrollbar-width:initial]">
          {caseStudies.map((project, index) => (
            <div
              key={project.id}
              className={cn(
                'w-[75vw] max-w-[75vw] shrink-0 rounded-2xl border border-gray-200 bg-white p-4 flex flex-col',
                {
                  'lg:flex-row': index % 2 === 0,
                  'lg:flex-row-reverse': index % 2 !== 0,
                },
                'gap-8 lg:w-auto lg:max-w-none lg:shrink lg:rounded-none lg:border-0 lg:bg-transparent lg:p-0 lg:gap-12 items-center',
              )}>
              {/* Image */}
              ...
              <div className="flex-1 space-y-4">
                ...
                <p className="text-gray-600 leading-relaxed whitespace-normal wrap-break-word">
                  {project.description}
                </p>
                <div className="pt-2">
