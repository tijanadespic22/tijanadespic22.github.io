const common = {
  ...
  Stranice: 'Pages',
  'UI/UX Dizajn & Web Development': 'UI/UX Design & Web Development',
  'Izrada web sajtova koji donose <0>nove klijente</0>':
    'I build websites that bring <0>new clients</0>',
  'Kreiram moderne, brze i responzivne web sajtove za brendove, mala preduzeća i startape - od prve ideje do lansiranja.':
    'I create modern, fast, and responsive websites for brands, small businesses, and startups — from the first idea to launch.',
  'Ono što radim': 'What I do',
  'Fokus na web development - od dizajna do lansiranja':
    'Focused on web development — from design to launch',
  'Ui/Ux Dizajn': 'UI/UX Design',
  'Wireframe-ovi, prototipi i interfejsi zasnovani na ponašanju korisnika.':
    'Wireframes, prototypes, and interfaces based on real user behavior.',
  'Web Development': 'Web Development',
  'Sajtovi u React-u i Next.js-u - brzi, skalabilni, lako se održavaju.':
    'React and Next.js websites — fast, scalable, and easy to maintain.',
  'Besprekoran prikaz na telefonu, tabletu i desktopu, bez izuzetaka.\n':
    'Flawless display on mobile, tablet, and desktop without exceptions.',
  ...
  'Web sajt za Stomatološku Ordinaciju': 'Dental Clinic Website',
  'Web sajt za Spa Centar': 'Spa Center Website',
  'Web sajt za Ketering Usluge': 'Catering Services Website',
  'Web sajt za Rent a Car': 'Car Rental Website',
  'Web sajt za Studio Forma': 'Studio Forma Website',
  'Web sajt za FK Loznica Junior': 'FK Loznica Junior Website',
  'Web sajt za Car detailing': 'Car Detailing Website',
  'Webshop za Šarene Čarape': 'Webshop for Šarene Čarape',
  'Aplikacija za Vodoinstalaterske Usluge': 'Plumbing Services App',
  'Aplikacija za Grooming Pasa ': 'Dog Grooming App',
  'Aplikacija za Fitnes Praćenje': 'Fitness Tracking App',
  'Dizajn i razvoj modernog, responzivnog web sajta za stomatološku ordinaciju "DentaVita", sa fokusom na poboljšanje korisničkog iskustva, povećanje angažmana i konverzija kroz intuitivan interfejs i optimizaciju sadržaja.':
    'Design and development of a modern, responsive website for the "DentaVita" dental clinic, focused on improving user experience, engagement, and conversions through an intuitive interface and content optimization.',
  'Dizajn i razvoj modernog, responzivnog web sajta za spa centar "Deluxe", sa fokusom na poboljšanje korisničkog iskustva, povećanje angažmana i konverzija kroz intuitivan interfejs i optimizaciju sadržaja.':
    'Design and development of a modern, responsive website for the "Deluxe" spa center, focused on improving user experience, engagement, and conversions through an intuitive interface and content optimization.',
  'Dizajn i razvoj modernog, responzivnog web sajta za ketering firmu "Ketering Smederevo", sa fokusom na poboljšanje korisničkog iskustva, povećanje angažmana i konverzija kroz intuitivan interfejs i optimizaciju sadržaja.':
    'Design and development of a modern, responsive website for the catering company "Ketering Smederevo", focused on improving user experience, engagement, and conversions through an intuitive interface and content optimization.',
  'Dizajn i razvoj modernog, responzivnog web sajta za rent a car firmu "AutoRent", sa fokusom na poboljšanje korisničkog iskustva, povećanje angažmana i konverzija kroz intuitivan interfejs i optimizaciju sadržaja.':
    'Design and development of a modern, responsive website for the car rental company "AutoRent", focused on improving user experience, engagement, and conversions through an intuitive interface and content optimization.',
  'Dizajn i razvoj modernog, responzivnog web sajta za Studio Forma, sa fokusom na poboljšanje korisničkog iskustva, povećanje angažmana i konverzija kroz intuitivan interfejs i optimizaciju sadržaja.':
    'Design and development of a modern, responsive website for Studio Forma, focused on improving user experience, engagement, and conversions through an intuitive interface and content optimization.',
  'Dizajn i razvoj modernog, responzivnog web sajta za fudbalski klub "Loznica Junior", sa fokusom na poboljšanje korisničkog iskustva, povećanje angažmana i konverzija kroz intuitivan interfejs i optimizaciju sadržaja.':
    'Design and development of a modern, responsive website for the football club "Loznica Junior", focused on improving user experience, engagement, and conversions through an intuitive interface and content optimization.',
  'Dizajn i razvoj modernog, responzivnog web sajta za webshop "Šarene Carape", sa fokusom na poboljšanje korisničkog iskustva, povećanje angažmana i konverzija kroz intuitivan interfejs i optimizaciju sadržaja.':
    'Design and development of a modern, responsive website for the webshop "Šarene Carape", focused on improving user experience, engagement, and conversions through an intuitive interface and content optimization.',
  'Dizajn i razvoj web aplikacije za praćenje i upravljanje uslugama šišanja pasa, uključujući zakazivanje, praćenje istorije usluga i analitiku zadovoljstva klijenata.':
    'Design and development of a web application for managing dog grooming services, including scheduling, service history tracking, and customer satisfaction analytics.',
  'Dizajn i razvoj web aplikacije za praćenje i upravljanje vodoinstalaterskim uslugama, uključujući zakazivanje, praćenje istorije usluga i analitiku zadovoljstva klijenata.':
    'Design and development of a web application for managing plumbing services, including scheduling, service history tracking, and customer satisfaction analytics.',
  'Redizajn i unapređenje korisničkog interfejsa mobilne aplikacije za fitnes praćenje, sa fokusom na poboljšanje korisničkog iskustva, povećanje angažmana i motivacije korisnika kroz gamification elemente.':
    'Redesign and enhancement of a fitness tracking mobile app interface, focused on improving user experience, engagement, and motivation through gamification elements.',
  ...
  'Povećanje broja zakazivanja usluga putem sajta za 45%':
    'Increased bookings through the website by 45%',
  ...
  'Izaberi paket koji ti odgovara': 'Choose the package that fits you',
  ...
  'Profesionalni sajt koji radi za tebe': 'A professional website that works for you',
  'Kompletno digitalno prisustvo': 'Complete digital presence',
  'Za kompleksne i jedinstvene projekte': 'For complex and unique projects',
  Najpopularniji: 'Most Popular',
  'od 99€': 'from 99€',
  'od 349€': 'from 349€',
  'od 699€': 'from 699€',
  'Po dogovoru': 'By agreement',
  'Logo dizajn (3 koncepta)': 'Logo design (3 concepts)',
  'PNG, SVG i PDF formati': 'PNG, SVG and PDF formats',
  'Paket boja i tipografije': 'Color and typography package',
  '2 runde revizija': '2 rounds of revisions',
  'Isporuka za 5 radnih dana': 'Delivery in 5 business days',
  'Do 5 stranica': 'Up to 5 pages',
  'Responzivan dizajn (mobile/tablet/desktop)': 'Responsive design (mobile/tablet/desktop)',
  'UI/UX dizajn u Figmi': 'UI/UX design in Figma',
  'Integracija kontakt forme': 'Contact form integration',
  'Osnovna SEO optimizacija': 'Basic SEO optimization',
  'Isporuka za 14 radnih dana': 'Delivery in 14 business days',
  'Do 10 stranica': 'Up to 10 pages',
  'Custom UI/UX dizajn': 'Custom UI/UX design',
  'CMS integracija': 'CMS integration',
  'Performanse & SEO': 'Performance & SEO',
  'Google Analytics setup': 'Google Analytics setup',
  'Isporuka za 21 radnih dana': 'Delivery in 21 business days',
  'Web aplikacija po meri': 'Custom web application',
  'Backend & API integracija': 'Backend & API integration',
  'Napredna animacija i interakcija': 'Advanced animation and interaction',
  'Neograničen broj stranica': 'Unlimited number of pages',
  'Prioritetna podrška': 'Priority support',
  'Dugoročno partnerstvo': 'Long-term partnership',
  Kreni: 'Get Started',
  'Pokreni Sajt': 'Launch Website',
  'Izaberi Pro': 'Choose Pro',
  'Specijalizovana za kreiranje modernih web sajtova i aplikacija koje kombinuju vrhunski dizajn sa besprekorno napisanim kodom.':
    'Specialized in creating modern websites and applications that merge premium design with carefully crafted code.',
  ...
  'Izbor radova koji mogu javno da podelim — od brendiranja i UI/UX dizajna do izrade web aplikacija.':
    'A selection of work I can publicly share — from branding and UI/UX design to web app development.',
  ...
  'Zbog ugovornih obaveza i zaštite poslovnih informacija klijenata, određeni projekti nisu\njavno dostupni. Ukoliko vas zanima detaljniji uvid u moj rad, slobodno me kontaktirajte\n — dodatne primere mogu podeliti direktno i diskretno.':
    'Due to contractual obligations and client confidentiality, some projects are not publicly available. If you want a more detailed overview, feel free to contact me and I can share additional examples privately.',
  'Imaš projekat na umu?': 'Have a project in mind?',
  'Uspešno poslato!': 'Message sent successfully!',
  'Odgovoriću vam u najkraćem mogućem roku.': 'I will get back to you as soon as possible.',
  Email: 'Email',
  '+381 65 358 0793': '+381 65 358 0793',
  Portfolio: 'Portfolio',
