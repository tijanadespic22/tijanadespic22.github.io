...
const Icon: FC<Icon> = ({width = 64, height = 64, className}) => {
  return (
    <svg
      ...
      <path
        fill="#ffa000"
        d="M17.474 103.276L33.229 2.462a2.91 2.91 0 0 1 5.44-.924l16.294 30.39l6.494-12.366a2.91 2.91 0 0 1 5.15 0l43.97 83.714z"></path>
      <path
        fill="#f57c00"
        d="M71.903 64.005L54.955 31.913l-37.481 71.363Z"></path>
      <path
        fill="#ffca28"
        d="M110.577 103.276L98.51 28.604a2.91 2.91 0 0 0-1.984-2.286a2.91 2.91 0 0 0-2.94.714l-76.112 76.243l42.115 23.618a8.73 8.73 0 0 0 8.51 0l42.478-23.618Z"></path>
      <path
        fill="#fff"
        fillOpacity=".2"
